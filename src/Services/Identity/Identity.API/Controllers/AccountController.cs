...
using Rainmaker.Services.Identity.API.Models.AccountViewModels;
using Rainmaker.Services.Identity.API.Services;
using System;
using System.Linq;
using System.Security.Claims;
using System.Threading.Tasks;

namespace Rainmaker.Services.Identity.API.Controllers
{
    /// <summary>
