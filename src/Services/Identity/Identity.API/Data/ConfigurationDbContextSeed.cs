...
using Rainmaker.Services.Identity.API.Configuration;
...
namespace Rainmaker.Services.Identity.API.Data
{
    public class ConfigurationDbContextSeed
    {
        public async Task SeedAsync(ConfigurationDbContext context, IConfiguration configuration)
        {
            ...
            clientUrls.Add("NotifyingApi", configuration.GetValue<string>("NotifyingApiClient"));
            clientUrls.Add("SignalrHub", configuration.GetValue<string>("SignalrHubClient"));
